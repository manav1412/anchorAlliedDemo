...
image_dir_path = r"/home/neebal/Desktop/POC/anchor-allied/denoised"

images = os.listdir(image_dir_path)

for image in images:
    image_path = f'{image_dir_path}/{image}'
    try:
        with Image.open(image_path) as img:
            img.verify()
    except (IOError, SyntaxError):
        print(f'\033[0;31mSkipping directory {image}...\033[0m')
        time.sleep(3)
        continue
    
    print(f'\033[1;33mProcessing Image {image} in {image_dir_path}...\033[0m')
    ...
    with open(f'{image_dir_path}/groq_outputs/{image[:-4]}.txt', 'w') as f:
